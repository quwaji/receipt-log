...
const CATEGORIES = [
  "食費", "外食費", "日用品", "家電・家具", "交通費", "自動車費",
  "通信費", "光熱費", "医療", "娯楽", "衣類", "教育", "保険", "住居費", "税金", "その他",
];
...
カテゴリの使い分け:
- 食費: スーパー・コンビニ・食料品購入
- 外食費: レストラン・カフェ・ファストフード・飲食店での食事
- 日用品: 消耗品・雑貨・ドラッグストアの生活用品
- 家電・家具: 家電製品・家具・大型耐久消費財
- 交通費: 電車・バス・タクシー・新幹線
- 自動車費: ガソリン・洗車・車検・点検・カー用品
- 税金: 固定資産税・自動車税・住民税・国民健康保険料
- 住居費: 家賃・管理費・修繕・水道料金
